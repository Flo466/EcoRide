...
INSERT IGNORE INTO `user` (
    ...
    `last_name`, `first_name`, `phone`, `address`, `birth_date`, `photo`, `updated_at`, `used_car_id`
) VALUES (
    1,
    ...
    FALSE,
    'System', 'Platform', NULL, NULL, NULL, NULL, NULL, NULL
);

-- Insert regular users
INSERT INTO `user` (
    `email`, `roles`, `password`, `last_name`, `first_name`, `phone`, `address`, `birth_date`,
    `photo`, `user_name`, `credits`, `created_at`, `updated_at`, `api_token`, `is_driver`, `used_car_id`
) VALUES
('john.doe@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Doe', 'John', '0700000001', '10 Elm Street, London', '1985-01-15 00:00:00', NULL, 'JohnD', 50, NOW(), NULL, 'Tkn_johndoe_123abc456def7890', TRUE, NULL),
('jane.smith@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Smith', 'Jane', '0700000002', '22 Oak Avenue, Manchester', '1990-03-20 00:00:00', NULL, 'JaneS', 50, NOW(), NULL, 'Tkn_janesmith_abc123def456789', TRUE, NULL),
('mike.brown@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Brown', 'Mike', '0700000003', '33 Pine Lane, Birmingham', '1988-07-01 00:00:00', NULL, 'MikeB', 50, NOW(), NULL, 'Tkn_mikebrown_456ghi789jkl0123', TRUE, NULL),
('sarah.white@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'White', 'Sarah', '0700000004', '44 Cedar Road, Leeds', '1992-11-10 00:00:00', NULL, 'SarahW', 50, NOW(), NULL, 'Tkn_sarahwhite_mno789pqr012345', TRUE, NULL),
('chris.green@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Green', 'Chris', '0700000005', '55 Birch Street, Glasgow', '1983-04-25 00:00:00', NULL, 'ChrisG', 50, NOW(), NULL, 'Tkn_chrisgreen_stu456vwx789012', TRUE, NULL),
('emily.black@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Black', 'Emily', '0700000006', '66 Willow Drive, Edinburgh', '1995-09-05 00:00:00', NULL, 'EmilyB', 50, NOW(), NULL, 'Tkn_emilyblack_yza012bcd345678', TRUE, NULL),
('daniel.grey@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Grey', 'Daniel', '0700000007', '77 Spruce Court, Bristol', '1987-02-28 00:00:00', NULL, 'DanielG', 50, NOW(), NULL, 'Tkn_danielgrey_efg901hij234567', TRUE, NULL),
('olivia.blue@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Blue', 'Olivia', '0700000008', '88 Poplar Place, Cardiff', '1991-06-12 00:00:00', NULL, 'OliviaB', 50, NOW(), NULL, 'Tkn_oliviablu_klm890nop123456', TRUE, NULL),
('william.red@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Red', 'William', '0700000009', '99 Ash Street, Belfast', '1984-10-03 00:00:00', NULL, 'WilliamR', 50, NOW(), NULL, 'Tkn_williamred_qrs789tuv012345', TRUE, NULL),
('sophia.yellow@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Yellow', 'Sophia', '0700000010', '100 Beach Road, Brighton', '1993-08-18 00:00:00', NULL, 'SophiaY', 50, NOW(), NULL, 'Tkn_sophiayellow_wxy678zab90123', TRUE, NULL),
('liam.jones@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Jones', 'Liam', '0700000011', '111 River Street, Dublin', '1990-02-01 00:00:00', NULL, 'LiamJ', 20, NOW(), NULL, 'Tkn_liamjones_abc456def7890123', FALSE, NULL),
('chloe.davis@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Davis', 'Chloe', '0700000012', '122 Hillside Road, Cork', '1994-05-10 00:00:00', NULL, 'ChloeD', 20, NOW(), NULL, 'Tkn_chloedavis_ghi123jkl4567890', FALSE, NULL),
('ben.miller@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Miller', 'Ben', '0700000013', '133 Valley View, Galway', '1986-09-22 00:00:00', NULL, 'BenM', 20, NOW(), NULL, 'Tkn_benmiller_mno789pqr0123456', FALSE, NULL),
('mia.wilson@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Wilson', 'Mia', '0700000014', '144 Lake Drive, Limerick', '1991-11-03 00:00:00', NULL, 'MiaW', 20, NOW(), NULL, 'Tkn_miawilson_stu456vwx7890123', FALSE, NULL),
('noah.moore@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Moore', 'Noah', '0700000015', '155 Forest Lane, Waterford', '1989-01-08 00:00:00', NULL, 'NoahM', 20, NOW(), NOW(), 'Tkn_noahmoore_yza012bcd3456789', FALSE, NULL),
('isabella.taylor@example.com', '["ROLE_USER"]', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.h7x/h1C/.', 'Taylor', 'Isabella', '0700000016', '166 Park Road, Kilkenny', '1993-04-17 00:00:00', NULL, 'IsabellaT', 20, NOW(), NULL, 'Tkn_isabellataylor_efg901hij234567', FALSE, NULL),

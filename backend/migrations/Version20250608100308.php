 ...
 */
final class Version20250608100308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE car CHANGE first_registration_date first_registration_date VARCHAR(10) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE car CHANGE first_registration_date first_registration_date VARCHAR(10) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'

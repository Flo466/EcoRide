 ...
 */
final class Version20251223113330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carpooling_user (id INT AUTO_INCREMENT NOT NULL, is_driver TINYINT(1) NOT NULL, is_cancelled TINYINT(1) DEFAULT 0 NOT NULL, user_id INT NOT NULL, carpooling_id INT NOT NULL, INDEX IDX_257FA72FA76ED395 (user_id), INDEX IDX_257FA72FAFB2200A (carpooling_id), UNIQUE INDEX UNIQ_257FA72FA76ED395AFB2200A (user_id, carpooling_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');

 ...
 */
final class Version20250629203414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE review ADD reviewed_user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_794381C6B9A2A077 ON review (reviewed_user_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_794381C6B9A2A077 ON review
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE review DROP reviewed_user_id
        SQL);
    }
}

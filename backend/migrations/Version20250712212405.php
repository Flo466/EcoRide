 ...
 */
final class Version20250712212405 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6491C40D50E FOREIGN KEY (used_car_id) REFERENCES car (id) ON UPDATE NO ACTION ON DELETE NO ACTION');

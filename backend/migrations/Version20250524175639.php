 ...
 */
final class Version20250524175639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE carpooling ADD car_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE carpooling ADD CONSTRAINT FK_6CC153F1C3C6F69F FOREIGN KEY (car_id) REFERENCES car (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_6CC153F1C3C6F69F ON carpooling (car_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_6CC153F1C3C6F69F ON carpooling
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE carpooling DROP car_id
        SQL);
        $this->addSql(<<<'SQL'

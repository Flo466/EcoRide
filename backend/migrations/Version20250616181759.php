 ...
 */
final class Version20250616181759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE carpooling CHANGE departure_time departure_time TIME NOT NULL, CHANGE arrival_date arrival_date DATE NOT NULL, CHANGE arrival_time arrival_time TIME NOT NULL, CHANGE seat_count seat_count INT NOT NULL, CHANGE price_per_person price_per_person DOUBLE PRECISION NOT NULL, CHANGE is_eco is_eco TINYINT(1) NOT NULL, CHANGE car_id car_id INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE carpooling CHANGE departure_time departure_time TIME DEFAULT NULL, CHANGE arrival_date arrival_date DATE DEFAULT NULL, CHANGE arrival_time arrival_time TIME DEFAULT NULL, CHANGE seat_count seat_count INT DEFAULT NULL, CHANGE price_per_person price_per_person DOUBLE PRECISION DEFAULT NULL, CHANGE is_eco is_eco TINYINT(1) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE car_id car_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'

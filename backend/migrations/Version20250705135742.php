 ...
 */
final class Version20250705135742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE car ADD seats INT NOT NULL, CHANGE first_registration_date first_registration_date DATE DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE car DROP seats, CHANGE first_registration_date first_registration_date VARCHAR(10) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'

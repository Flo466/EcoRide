 ...
 */
final class Version20250524174916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE car ADD user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_773DE69DA76ED395 ON car
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE car DROP user_id
        SQL);
        $this->addSql(<<<'SQL'
